...
CREATE TABLE item_itm (id_itm INTEGER NOT NULL DEFAULT nextval('id_itm_seq'), barcode BIGINT NULL UNIQUE, price DECIMAL(6,2) NOT NULL, quantity INTEGER NULL, title TEXT NOT NULL, PRIMARY KEY (id_itm));
