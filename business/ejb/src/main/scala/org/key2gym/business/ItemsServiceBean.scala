 ...
 */
@Stateless
// TODO: Remove hard-coded roles from here
@DeclareRoles(Array("manager", "junior_administrator", "senior_administrator"))
@RolesAllowed(Array("manager", "junior_administrator", "senior_administrator"))
@Remote(Array(classOf[ItemsServiceRemote]))
class ItemsServiceBean extends BasicBean with ItemsServiceRemote {
