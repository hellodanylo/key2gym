...
import org.key2gym.client.dialogs.actions.CancelAction;
...
public class FormPanelDialogsFactory {
    ...
    private static ResourceBundle strings = ResourceBundle.getBundle("org/key2gym/client/resources/Strings");
}
