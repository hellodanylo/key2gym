...
public class AboutDialog extends AbstractDialog {
    ...
    public AboutDialog(JFrame parent) {
     ...
     private void buildDialog() {
        ...
        logoLabel.setIcon(new ImageIcon(getClass().getResource("/org/key2gym/presentation/resources/splash.png"))); // NOI18N
        ...
        informationEditorPane.setMinimumSize(new Dimension(500, 300));
